  ...
  def table_columns(newspaper_base)
    {
       ...
       #TODO add a tooltip for new box flg - 'Please click to change the flg'
       new_box_flg: -> { best_in_place newspaper_base, :new_box_flg, type: :checkbox, collection: ["否", "是"] },
