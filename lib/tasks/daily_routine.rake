...
task backup_database: :environment do
  system "mysqldump -u epoch -pfldfh0513 -h faxing.cbljlxerf51m.us-east-1.rds.amazonaws.com faxing > /home/epoch/newspaper_db/mysql_dump_#{Time.now.strftime("%d%m%Y-%H:%M")}.sql"
end
